...
### 🖥️ Desenvolvimento & Banco de Dados
...
2. **Rewards bing automator**: App para automação de pesquisas bing usando IA. [Link para o app](https://github.com/Messihprx/bing-rewards-automator-IA)
